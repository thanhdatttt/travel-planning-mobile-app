...
public class AdminUserFilterDialog extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireParentFragment()).get(AdminUserViewModel.class);

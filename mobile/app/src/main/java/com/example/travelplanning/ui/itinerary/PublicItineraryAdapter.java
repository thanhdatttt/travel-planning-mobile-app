...
public class PublicItineraryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ItineraryDisplayItem.TYPE_HEADER) {
            View view = inflater.inflate(R.layout.item_public_itinerary_header, parent, false);
            return new HeaderViewHolder(view);
        } else {
            View view = inflater.inflate(R.layout.item_public_itinerary_location, parent, false);
